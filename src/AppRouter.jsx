...
import { PanelAdminRol } from "./panelAdminRol/components/PanelAdminRol"
        ...
        <>
            ...
            <Routes>
                ...
                <Route path="/panel-adminhotel" element={isAdminHotelAuthenticated() ? (<PanelAdminHotel/>) : (<Navigate to="/login" />) } >
                 ...
                 {/* RUTAS SOLO PARA ADMIN_HOTEL*/}
                 <Route path="/panel-adminrol" element={isAdminHotelAuthenticated() ? (<PanelAdminRol/>) : (<Navigate to="/login" />) } >
                </Route>
